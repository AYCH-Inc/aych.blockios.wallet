...
struct LocalizationConstants {
    ...
    struct Authentication {
        ...
        struct ImportKeyPasswordScreen {
            static let title = NSLocalizedString(
                "Private Key Needed",
                comment: "Password screen: title for general action"
            )
        ...
        static let loadingWallet = NSLocalizedString("Loading Your Wallet", comment: "")
    ...
    struct Pin {
        ...
        static let enableBiometricsNotNowButton = NSLocalizedString(
            "Not Now",
            comment: "Cancel button for alert letting the user to enable biometrics authenticators"
        )
        
        static let logoutButton = NSLocalizedString(
            "Log Out",
            comment: "Button for opting out in the PIN screen"
        )
        
        static let changePinTitle = NSLocalizedString(
            "Change PIN",
            comment: "Title for changing PIN flow"
        )
        
        static let pinSuccessfullySet = NSLocalizedString(
            "Your New PIN is Ready",
            comment: "PIN was set successfully message label"
        )
        
        static let createYourPinLabel = NSLocalizedString(
            "Create Your PIN",
            comment: "Create PIN code title label"
        )
        
        static let confirmYourPinLabel = NSLocalizedString(
            "Confirm Your PIN",
            comment: "Confirm PIN code title label"
        )
        
        static let enterYourPinLabel = NSLocalizedString(
            "Enter Your PIN",
            comment: "Enter PIN code title label"
        )
        
        static let tooManyAttemptsTitle = NSLocalizedString(
    ...
    struct Onboarding {
        ...
        struct ManualPairingScreen {
            struct TwoFAAlert {
                static let wrongCodeTitle = NSLocalizedString(
                ...
                static let wrongCodeMessage = NSLocalizedString(
            ...
            struct RequestOtpMessageErrorAlert {
                static let title = NSLocalizedString(
                    "An Error Occurred",
    ...
    struct Exchange {
        static let title = NSLocalizedString("Exchange", comment: "Title for the Exchange")
        ...
        static let twoFactorNotEnabled = NSLocalizedString("Please enable 2FA on your Exchange account to complete deposit.", comment: "User must have 2FA enabled to deposit from send.")
        struct Alerts {
            static let connectingYou = NSLocalizedString("Connecting You To The Exchange", comment: "Connecting You To The Exchange")
            ...
            static let successDescription = NSLocalizedString("Please return to the Exchange to complete account setup.", comment: "Please return to the Exchange to complete account setup.")
            static let error = NSLocalizedString("Connection Error", comment: "Connection Error")
            static let errorDescription = NSLocalizedString("We could not connect your Wallet to The Exchange. Please try again", comment: "We could not connect your Wallet to The Exchange. Please try again")
        }
        ...
        struct Launch {
            static let launchExchange = NSLocalizedString("Launch The Exchange", comment: "")
            static let contactSupport = NSLocalizedString("Contact Support", comment: "")
        }
        struct ConnectionPage {
            struct Descriptors {
                static let description = NSLocalizedString("There's a new way to trade. Link your Wallet for instant access.", comment: "Description of the exchange.")
            ...
            struct Features {
                static let exchangeWillBeAbleTo = NSLocalizedString("Our Exchange will be able to:", comment: "")
                ...
                static let exchangeWillNotBeAbleTo = NSLocalizedString("Will Not:", comment: "")
    ...
    struct Send {
        ...
        struct Destination {
            ...
            static let exchangeCover = NSLocalizedString(
                "Exchange %@ Address",
                comment: "Exchange address for a wallet"
            )
        }
    ...
    // TODO: Move to PlatformKit when LocalizationConstants becomes an extension to PlatformKit
    struct Biometry {
    ...
    struct SendAsset {
        static let useTotalSpendableBalance = NSLocalizedString(
            "Use total spendable balance: ",
            comment: "String displayed to the user when they want to send their full balance to an address."
        )
    ...
    struct Address {
        struct Accessibility {
            static let addressLabel = NSLocalizedString(
                "This is your address",
                comment: "Accessibility hint for the user's wallet address")
            static let addressImageView = NSLocalizedString(
        ...
        static let copiedButton = NSLocalizedString(
            "Copied!",
        ...
        static let creatingStatusLabel = NSLocalizedString(
            "Creating a new address",
            comment: "Creating a new address status label")
        static let loginToRefreshAddress = NSLocalizedString(
...
@objc class LocalizationConstantsObjcBridge: NSObject {
    ...
    @objc class func etherSecondPasswordPrompt() -> String { return LocalizationConstants.Authentication.EtherPasswordScreen.description }

    @objc class func privateKeyNeeded() -> String { return LocalizationConstants.Authentication.ImportKeyPasswordScreen.title }
    ...
    @objc class func twoFactorExchangeDisabled() -> String { return LocalizationConstants.Exchange.twoFactorNotEnabled }
    
    @objc class func sendAssetExchangeDestination() -> String { return LocalizationConstants.Exchange.Send.destination }
    ...
    @objc class func loadingWallet() -> String { return LocalizationConstants.Authentication.loadingWallet }
    ...
    @objc class func gettingQuote() -> String { return LocalizationConstants.Swap.gettingQuote }

    @objc class func confirming() -> String { return LocalizationConstants.Swap.confirming }

    @objc class func loadingTransactions() -> String { return LocalizationConstants.Swap.loadingTransactions }
    ...
    @objc class func loadingExchange() -> String { return LocalizationConstants.Swap.loading }
