...
public enum NewResult<Success, Failure: Error> {
    ...
    public func flatMap<NewSuccess>(
        _ transform: (Success) -> NewResult<NewSuccess, Failure>
        ) -> NewResult<NewSuccess, Failure> {
        switch self {
        case let .success(success):
    ...
    public func flatMapError<NewFailure>(
        _ transform: (Failure) -> NewResult<Success, NewFailure>
        ) -> NewResult<Success, NewFailure> {
        switch self {
        case let .success(success):
            return .success(success)
